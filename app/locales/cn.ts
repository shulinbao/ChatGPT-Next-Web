...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ? `😆 第一次来到 HorseGPT Chat?
       \\ 1️⃣ 如果你不清楚什么是 HorseGPT Chat，[点击这里了解详情 🚀](${SAAS_CHAT_UTM_URL})`
      : `😆 第一次来到 HorseGPT Chat?
       \ 1️⃣ 如果你不清楚什么是 HorseGPT Chat，[点击这里了解详情 🚀](${SAAS_CHAT_UTM_URL})
       \ 2️⃣ 如果你已经购买了 HorseGPT API 的兑换码并生成了令牌，点击[这里](/#/auth)输入你的令牌就可以使用了 🔑
       `,
  },
  Auth: {
    Return: "返回",
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        ...
        Label: "（方便、快捷）",
        SubTitle:
          "由 HorseGPT 项目维护, 支持 OpenAI o1, GPT-4o 等最新大模型",
