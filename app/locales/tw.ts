...
const tw = {
  ...
  Error: {
    ...
    \ 2️⃣ 如果你已經生成了 HorseGPT API 的令牌，[點擊這裡](https://oneapi.nu.ac.cn/token)找到你的令牌，並點擊右邊的聊天按鈕，導入令牌使用 🔑
 ...
 `,
  ...
  Auth: {
    Title: "需要密碼",
    Tips: "如果您被授權使用不限量服務，請在這裡輸入密碼",
    SubTips: "或者輸入你的 HorseGPT API 令牌",
    Input: "在此處填寫存取密碼",
    Confirm: "確認",
    Later: "稍候再說",
    Return: "返回",
  ...
  Export: {
    ...
    MessageFromChatGPT: "來自 HorseGPT 的訊息",
    Format: {
      Title: "匯出格式",
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      Title: "匯入系統提示",
      SubTitle: "強制在每個請求的訊息列表開頭新增一個模擬 HorseGPT 的系統提示",
    },
    InputTemplate: {
      Title: "使用者輸入預處理",
    ...
    Access: {
      SaasStart: {
        Title: "使用 HorseGPT API",
        Label: "(方便、快捷案)",
        SubTitle:
          "由 HorseGPT 項目維護，支持 OpenAI o1, GPT-4o 等最新大模型",
        ChatNow: "立刻前往 HorseGPT API",
      },
